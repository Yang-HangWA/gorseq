...
func init() {
	masterCommand.PersistentFlags().Bool("debug", true, "use debug log mode")
	masterCommand.PersistentFlags().StringP("config", "c", "/home/hangyang/gorse/config/config.toml.template", "configuration file path")
